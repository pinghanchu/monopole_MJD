...
void G4MonopolePhysics::ConstructParticle()
{
  ...
  std::cout << "Monopole defintion:" << fMonopoleMass << "MeV ,"<< fMagCharge << "," << fElCharge << std::endl;
}
...
void G4MonopolePhysics::ConstructProcess()
{
  ...
  std::cout << "Monopole magnetic charge:" << magn << "; Energy:" << emin << "-" << emax <<std::endl;
  ...
  if(fMpl->GetPDGCharge() != 0.0) {
    ...
    std::cout << fMpl->GetPDGCharge() << ", Mini energy:" << emin << ", Max energy:" << emax << std::endl;
  }
  if(magn != 0.0) {
    ...
    std::cout << magn << ", Mini energy:" << emin << ", Max energy:" << emax << std::endl;
